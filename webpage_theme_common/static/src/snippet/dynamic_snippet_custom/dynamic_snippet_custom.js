...
import DynamicSnippetProducts from "@website_sale/js/s_dynamic_snippet_products"; 
...
// ⚠️ Usa un nombre único en el registry para evitar colisiones
publicWidget.registry.dynamic_snippet_products_wysiwyg = DynamicSnippetProductsWysiwyg;
