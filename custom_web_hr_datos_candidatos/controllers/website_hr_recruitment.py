        ...
        try:
            ...
            while kwargs.get(f'famNombre_{k}') is not None:
                ...
                if name:
                    ...
                    if doc_type == 'part_naci':
                        ...
                        values['cedula'] = kwargs.get(f'famCedula_{k}')

                    family_lines.append((0, 0, values))
            ...
            while kwargs.get(f'titulo_{i}') is not None:
                ...
                if titulo and level_id:
                    country_id, _ = parse_location(kwargs.get(f'paisEducacion_{i}'))
                    _, state_id   = parse_location(kwargs.get(f'ciudad_{i}'))
            ...
            while kwargs.get(f'cargo_{j}') is not None:
                ...
                if cargo:
                    country_id, _ = parse_location(kwargs.get(f'paisExperiencia_{j}'))
                    _, state_id   = parse_location(kwargs.get(f'ciudadExperiencia_{j}'))
