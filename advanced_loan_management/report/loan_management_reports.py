...
class LoanDetails(models.AbstractModel):
    ...
    def _get_report_values(self, doc_ids, data=None):
        ...
        data = {
            ...
            'CustomerAddress': f"{loan_id.partner_id.street or ''} "
                   f"{loan_id.partner_id.city}" if loan_id.partner_id.city else '',
            ...
            'disbursal_amount': str(loan_id.disbursal_amount),
            'entry_amount': str(loan_id.entry_amount),
            'Product_name': str(loan_id.product_id.name),
        }
