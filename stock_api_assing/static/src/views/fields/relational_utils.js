...
import { SelectCreateDialogCustom } from "@stock_api_assing/views/view_dialogs/select_create_dialog";
...
export function useSelectCreate({ resModel, activeActions, onSelected, onCreateEdit, onUnselect }) {
    ...
    function selectCreate({ domain, context, filters, title, kanbanViewId }) {
        addDialog(SelectCreateDialogCustom, {
...
export class Many2XAutoCompleteCustom extends Component {
    setup() {
...
Many2XAutoCompleteCustom.template = "web.Many2XAutoCompleteCustom";
Many2XAutoCompleteCustom.components = { AutoComplete };
Many2XAutoCompleteCustom.defaultProps = {
    searchLimit: 7,
    searchMoreLimit: 320,
