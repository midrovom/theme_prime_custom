...
export class SelectCreateDialogCustom extends Component {
    setup() {
...
SelectCreateDialogCustom.components = { Dialog, View };
SelectCreateDialogCustom.template = "web.SelectCreateDialogCustom";

SelectCreateDialogCustom.defaultProps = {
    dynamicFilters: [],
    multiSelect: true,
    searchViewId: false,
    type: "list",
