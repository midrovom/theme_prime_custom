{
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'conedera_theme_common/static/src/snippets/header_mobile_custom/header_mobile.scss',
            'conedera_theme_common/static/src/snippets/template_products/image_product.scss',
