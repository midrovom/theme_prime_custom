    ...
    def _filter_records_to_values(self, records, is_sample=False):
        ...
        if self.model_name == 'product.product':
            for data in res:
                ...
                brand_name = ""
                for val in product.attribute_line_ids.mapped('value_ids'):
    ...
    def _get_products_by_brand(self, mode=None, **kwargs):
        ...
        if not brand_id:
            ...
            for cond in search_domain:
                if cond[0] == 'attribute_line_ids.value_ids' and cond[1] in ('in', '=', 'ilike'):
                    brand_id = cond[2]
        ...
        # Filtrar productos por atributo de marca
        domain = [
