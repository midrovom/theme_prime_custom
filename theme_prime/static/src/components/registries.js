...
registry.category('theme_prime_card_registry')
    ...
    // Nuevos registros para temas personalizados
    ...
    .add('s_card_style_11', { supportedActions: [...new Set([...PRODUCTS_ACTIONS, ...['show_similar']])], mobileStyle: 's_mobile_card_style_5'})
    .add('s_card_style_12', {supportedActions: PRODUCTS_ACTIONS})
...
registry.category('theme_prime_mobile_card_registry')
    ...
    .add('s_mobile_card_style_4', {supportedActions: []})
    .add('s_mobile_card_style_5', {supportedActions: []})
    .add('s_mobile_card_style_6', {supportedActions: []})
...
registry.category('theme_prime_snippet_registry')
    ...
    .add('s_d_brand_snippet', { widgets: { TpRecordSelector: { model: 'product.attribute.value', fields: ['name'], isBrand: true, fieldsToMarkUp: [], defaultVal: { selectionType: 'manual', recordsIDs: [], model: 'product.attribute.value' } }, defaultValue: { recordsLimit: 30 }, TpUiComponent: { cardRegistry: 'theme_prime_brand_card_registry', defaultVal: { style: 'tp_brand_card_style_1', mode: 'slider' } }, ...EXTRA_OPTIONS } })
