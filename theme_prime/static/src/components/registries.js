...
registry.category('theme_prime_snippet_registry')
    ...
    .add('s_d_category_snippet', { widgets: { ...CATEGORY_SELECTOR_DATA, TpUiComponent: { cardRegistry: 'theme_prime_card_registry', defaultVal: { tabStyle: 'tp-droggol-18-builder-snippet-tab-1', mode: 'slider', limit: 8, ppr: 4, includesChild: true, mobileConfig: { style: 'default', mode: 'default' } } }, ...EXTRA_OPTIONS } })
