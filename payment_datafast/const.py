...
# Currency codes of the currencies supported by DataFast in ISO 4217 format.
# See https://api.datafast.com/currencies. Last seen online: 24 November 2022.
...
# Mapping of transaction states to DataFast payment statuses.
# See https://www.datafast.com.mx/developers/en/reference/payments/_payments_id/get.
...
# Mapping of error states to DataFast error messages.
# See https://www.datafast.com.ar/developers/en/docs/checkout-api/response-handling/collection-results
